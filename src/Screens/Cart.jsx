        ...
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {items.map((item) => {
                ...
                return (
                  <div key={product.id} className="flex flex-col sm:flex-row items-center gap-6 bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                    {/* Product Image */}
                    <div className="w-28 h-28 bg-gray-50 rounded-lg overflow-hidden ">
                      <img 
                      ...
                      <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 mt-4">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg bg-gray-50">
                          <button 
                            ...
                            className="px-3 py-1 hover:text-indigo-600 text-black transition-colors font-bold"
                          >-</button>
                          <span className="px-4 py-1 text-sm font-semibold border-x text-black  border-gray-200 bg-white">
                            {item.qunatity}
                          </span>
                          <button 
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit sticky top-24">
              ...
              className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold hover:bg-black transition-all transform active:scale-[0.98]">
                Proceed to Checkout
              </button>
